...
from cdt.models import Preferencias
    ...
    def post(self, request):
        ...
        try:
            preferencias = Preferencias.objects.create(
                ...
                notificaciones_email=request.data.get(
                    'notificaciones_email', True
                ),
                notificaciones_push=request.data.get(
...
class PreferenciasDetailAPIView(APIView):
    ...
    def put(self, request, user_id):
        ...
        try:
            preferencias = Preferencias.objects.get(user_id=user_id)
            preferencias.tema_oscuro = request.data.get(
                'tema_oscuro', preferencias.tema_oscuro
            )
            preferencias.notificaciones_email = request.data.get(
                'notificaciones_email', preferencias.notificaciones_email
            )
            preferencias.notificaciones_push = request.data.get(
                'notificaciones_push', preferencias.notificaciones_push
            )
            preferencias.idioma = request.data.get(
                'idioma', preferencias.idioma
            )
            preferencias.save()
            return Response({
